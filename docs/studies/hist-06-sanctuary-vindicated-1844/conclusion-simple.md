...
- → Greek *katharisthesetai* (cleansed)
...
1. **Judgment language** ("the hour of his judgment is come") corresponds to *nitsdaq* (vindicated)
2. **Creation language** ("worship him that made heaven and earth") corresponds to *ereb boqer* (the creation-day pattern)
