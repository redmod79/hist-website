...
**Definition:** A brief space (of time); with ἐν, in haste/with speed
...
The seven occurrences demonstrate three distinct semantic categories:
1. **Manner-of-action** (Acts 12:7; 22:18) — Speed of the action itself, not timing of fulfillment
2. **Temporal nearness** (Acts 25:4) — Event occurring in the near future
3. **Eschatological** (Luk 18:8; Rom 16:20; Rev 1:1; 22:6) — Speed/certainty of divine action within salvation-historical framework

The eschatological uses cannot be reduced to simple temporal nearness:
- Luke 18:8: "speedily" is juxtaposed with "though he bear long" and "shall he find faith?" — implying duration
...
- Jer 27:16 — false prophets say vessels return "**shortly**" (warning against misuse of "shortly")
...
**Part of Speech:** Adverb (neuter singular of tachys used adverbially)
**Definition:** Shortly, without delay, soon, quickly
...
1. **Conditional-disciplinary** (2:5; 2:16): "I will come quickly" = swiftly/suddenly for church judgment, conditional on non-repentance
2. **Transitional** (3:11): Between disciplinary and eschatological — "hold fast"
3. **Narrative-sequential** (11:14): "the third woe cometh quickly" — within the visionary sequence
4. **Eschatological** (22:7; 22:12; 22:20): Triple "I come quickly" in the epilogue — escalating: plain statement > with reward > emphatic Nai ("Surely")
...
The 7 hypomonE references co-occur with 8+ "quickly/shortly" references across Revelation:
- en tachei appears in 1:1 (with hypomonE in 1:9) and 22:6
- tachy appears in 2:5 (with hypomonE in 2:2,3), 2:16, 3:11 (with hypomonE in 3:10), 22:7, 22:12, 22:20
- If all events were truly imminent, the repeated exhortations to patient endurance would be structurally unnecessary
...
**Definition:** An occasion, set or proper time; appointed season
**BLB Count:** 87
...
**Original:** δεῖ
**Transliteration:** deî
**Part of Speech:** Verb (impersonal, 3rd person singular)
**Definition:** It is necessary; it must be
**BLB Count:** 106

### The "ha dei genesthai" Formula
The phrase "ha dei genesthai" (ἃ δεῖ γενέσθαι) = "things which must come to pass" appears in:
- **Daniel 2:28 LXX** — + "ep' eschatou ton hemeron" (in the last days)
- **Rev 1:1** — + "en tachei" (shortly/with quickness)
- **Rev 22:6** — + "en tachei" (shortly/with quickness)
...
**Part of Speech:** Verb
**Definition:** To be long-spirited; to be forbearing, patient
...
**Part of Speech:** Verb
**Definition:** To delay, be slow, tarry
...
bradynO is the **semantic ANTONYM** of tachos:
- tachos = speed, quickness
- bradynO = delay, slowness
Peter uses bradynO to deny that God is "delaying" and uses makrothumeO to explain the apparent interval.
...
**Part of Speech:** Verb
**Definition:** From chronos; to take time, linger, delay
...
chronizO appears in parables that explicitly build in delay:
- Mat 24:48 / Luk 12:45 — delay is a test; the evil response is to presume upon the delay
- Mat 25:5 — the bridegroom's tarrying is a narrative fact, not a moral failure
- Heb 10:37 — the promise is "he will NOT chronizO" — quoting Hab 2:3
